...
def create_and_train_model(optimizer_name, init_method, stddev, lr, clipnorm, batch_size, 
    ...
    for iteration in range(num_iterations):
        ...
        # 训练参数
        epochs = 100 if eval_mode else 200  # 评估模式使用较少epochs
...
def main():
    ...
    trial_df.to_csv('parameter_tuning_detailed_results_sp500.csv', index=False)
    ...
    if best_params:
        ...
        best_params_df.to_csv('best_optimization_parameters_sp500.csv', index=False)
        
        print("\n调优完成！结果文件:")
        print("- parameter_tuning_detailed_results_sp500.csv: 详细试验记录")
        print("- best_optimization_parameters_sp500.csv: 最佳参数配置")
