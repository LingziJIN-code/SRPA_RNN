...
# 创建文件并写入表头 
filename = 'parameter_tuning_detailed_SPLQP_averaged_sp500.csv'
fieldnames = [
...
with open(filename, 'a', newline='') as csvfile:  # 以追加模式打开文件
                ...
                for eta1 in param_space['eta1']:
                    for eta2 in param_space['eta2']: 
                        ...
                        for repeat in range(num_repeats):
                            ...
                            results = SPLQP_ReLU_optimization(dataset_name=dataset_name, Ny=Ny, Nh=Nh, maxiter=100, 
                            distribution_type=init_method, mean=0, std=stddev, 
                            beta1=0.1, beta2=0.1, lambda1 = 1 / (Nh * Ny), lambda2 = 1 / (Nh * Nh), lambda3 = 1 / (Nx * Nh), lambda4 = 1 / Nh, lambda5 = 1 / Ny, 
    ...
    best_params_df.to_csv('best_SPLQPaveraged_sp500_parameters.csv', index=False) 
